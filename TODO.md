...
## Current Version
v3.0.7 (RELEASED) → v3.0 (IN PROGRESS)

Core booking flow is operational.

**v3.0 Progress:** Booking management UX polished with dedicated manage page, cleaner redirect flows, and clearer reschedule/cancel outcomes.
